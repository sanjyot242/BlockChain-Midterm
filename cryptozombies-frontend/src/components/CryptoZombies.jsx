...
import contractAddresses from '../../../migrations/2_deploy_contracts';
...
const CryptoZombies = () => {
  ...
  const fetchContractAddress = async () => {
    try {
      ...
      const zombieOwnershipLine = lines.find(line => line.includes('zombieownership'));
