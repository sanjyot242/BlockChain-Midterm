...
9. **Zombies cards are dynamically changed based on current user account**
10. **Added Autogenerated Images based on the name and ID of the zombie (used https://robohash.org/)**
11. **Each User can create up to 6 zombies**
12. **Used Latest Metamask Web3 API to connect to Ganache**
13. **Custom Script to fetch new and updated ABI from the build folder to be used in front-end**
